"""
stmate.xlsx 일위대가_산근 시트 파서 v4 (완전한 순서 보존)
...
def parse_stmate_sangcul():
    """stmate.xlsx의 일위대가_산근 시트 파싱 (완전한 순서 보존)"""
    ...
    try:
        ...
        # JSON 파일로 저장
        output_file = 'stmate_sangcul_parsed_v4.json'
